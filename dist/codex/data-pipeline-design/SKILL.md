...
## Saída esperada
1. Pipeline architecture diagram with data flow.
2. Pattern decision (ETL/ELT, batch/streaming) with rationale.
3. Transformation logic specification.
4. Idempotency strategy per pipeline stage.
5. Failure handling and monitoring plan.
